...
export default function Home() {
  ...
  return (
    <div className="grid h-screen grid-rows-[52px_1fr_140px]">
      ...
      <div className="grid h-full justify-center content-center">
        <Text size="text-[28px] lg:text-[32px]" weight="font-semibold" align="text-center" color="text-black-100">안녕하세요<br />김태준입니다.</Text>
      </div>
      <div className="grid h-full justify-center content-center">
        <Button variant="flat" color="black" width="w-[335px]" borderRadius="rounded-[12px]" height="h-[58px]"
          onClick={() => submit()}>
          {
            isPending ? (
              ...
              <Text size="text-[16px] lg:text-[24px]" color="text-white-100" weight="font-semibold">다음</Text>
            )
          }
        </Button>
      </div>
